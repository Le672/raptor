...
import { BookOpen, RefreshCw, Star, X } from "lucide-react";
...
export function AlbumModal({ albumId, cachedData, isFavorite, onToggleFavorite, onClose }: {
    albumId: string;
    cachedData: BatchAlbumItem | undefined;
    isFavorite: boolean;
    onToggleFavorite: (item: { id: string; name: string; author: string }) => void;
    onClose: () => void;
}) {
